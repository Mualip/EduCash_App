...
$query = "SELECT 
          ...
          WHERE t.jenis_pembayaran = 'daftar ulang' AND t.id_admin = '$id_admin'";  // Tambahkan filter berdasarkan id_admin
...
$totalQuery = "SELECT COUNT(*) 
               FROM siswa s 
               JOIN total t ON s.nis_siswa = t.nis_siswa 
               WHERE t.jenis_pembayaran = 'uang masuk' AND t.id_admin = '$id_admin'";  // Tambahkan filter berdasarkan id_admin
