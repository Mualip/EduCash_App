...
if (!isset($_SESSION['siswa']) && !isset($_SESSION['user'])) {
    // Jika tidak ada session untuk siswa atau admin, arahkan ke halaman login
    header("Location: login.php");
    exit;
}

// Jika sudah login, lanjutkan untuk memuat konten halaman
?>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar fixed-top">
        ...
        <!-- <a class="inline-block mr-4 py-0.5 text-xl whitespace-nowrap hover:no-underline focus:no-underline"
                href="index.html">
                <img src="users/images/yadin.jpg" alt="Yadin's photo" class="h-8" />
            </a>
-->
            <button
            ...
            <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center"
                ...
                <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                    ...
                    <li>
                        <a class="nav-link page-scroll" href="#total_biaya_pertahun">Total Biaya Pertahun</a>
                    </li>
                    <li>
                        <a class="nav-link page-scroll" href="#histori_transaksi">Histori Transaksi</a>
                    </li>
                    <li>
                        <a class="nav-link page-scroll" href="#profil_siswa">Profil Siswa</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../login.php">
                            <!-- Menggunakan ../ untuk mengarah ke folder yang lebih tinggi -->
   ...
   <!-- Header -->
   <header id="header" class="header py-10 text-center md:pt-28 lg:text-left xl:pt-32 xl:pb-24">
    <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8" style="margin-top:-200px;" >
        <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
            <h1 class="h1-large mb-5">EduCash - Aplikasi Keuangan Sekolah</h1>
            <p class="p-large mb-8">Kelola pembayaran sekolah dengan mudah dan praktis, langsung dari genggaman tangan Anda. EduCash menawarkan kemudahan transaksi dan transparansi untuk orang tua, siswa, dan pihak sekolah.</p>
        </div>
    </div> <!-- end of container -->
...
<!-- end of header -->
    ...
    <!-- Features -->
    <div id="total_biaya_pertahun" class="cards-1">
        <div class="container px-4 sm:px-8 xl:px-4" style="margin-top:100px;">
    ...
    <!-- Details 1 -->
    <div id="histori_transaksi" class="pt-12 pb-16 lg:pt-16">
    ...
    <!-- Pricing -->
    <div id="profil_siswa" class="cards-2">
