...
if (isset($_POST['simpan'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Jika NIS belum ada, buat password default dan hash password
        $default_password = '12345678';  // Password default
        $hashed_password = password_hash($default_password, PASSWORD_DEFAULT);  // Enkripsi password

        // Masukkan data siswa dengan password yang sudah di-hash
        ...
        // Bind parameters, termasuk password yang sudah di-hash dan id_admin dari session
        $stmt_insert_siswa->bind_param('sssssssssssssi', 
