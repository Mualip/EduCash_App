    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index_akses_full.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseInputData" class="collapse" aria-labelledby="headingInputData"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="input_kategori_pembayaran.php">Input jenis Pembayaran</a>
                        <a class="collapse-item" href="input_tarif_pembayaran.php">Input Tarif Bulanan</a>
                        <a class="collapse-item" href="input_biaya_pertahun.php">Input Tarif Tahunan</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseEditPembayaran"
                    aria-expanded="false" aria-controls="collapseEditPembayaran">
                    <i class="fas fa-fw fa-edit"></i> <!-- Ikon Edit Pembayaran -->
                    <span>Edit Pembayaran</span>
                </a>
                <div id="collapseEditPembayaran" class="collapse" aria-labelledby="headingEditPembayaran"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Edit Data Pembayaran:</h6>
                        <a class="collapse-item" href="edit_kategori.php">Edit jenis Pembayaran</a>
                        <a class="collapse-item" href="edit_biaya_pertahun.php">Edit Biaya Pertahun</a>
                        <a class="collapse-item" href="edit_tarif.php">Edit Biaya Perbulan</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePengaturan" class="collapse" aria-labelledby="headingPengaturan"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="profil_sekolah.php">Profil Sekolah</a>
                        <a class="collapse-item" href="backup_data.php">Backup Data</a>
                        <a class="collapse-item" href="register.php">Register Admin</a>
                        <a class="collapse-item" href="perbaikan_admin.php">Forgot Admin</a>
                        <a class="collapse-item" href="forgot_password_siswa.php">Forgot Siswa</a>
                    </div>
                </div>
                <li class="nav-item">
